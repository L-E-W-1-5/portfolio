...
export const projects = [
    {
        ...
        details: `(Demo button now added. Complete afterthought!). A web application with a front end made using React, Typescript and Bootstrap and a back end made with Node.js, Express and Postgres, along with an AWS S3 Bucket. It acts similarly to popular movie streaming sites or with alteration to the user database plus some extra UI components, it could also be similar to YouTube.
        ...
        This issue went on for longer than this with the next issue being my player on the front end not recognising the .m3u8, still having short videos that werent HLS that needed to play.. I could reel off numerous other issues I had like this, I enjoyed the challenge and was able to persevere, I can now reflect on what I would do differently next time.. quite a lot! I look forward to starting on a fresh project bringing with me all the things ive learnt.`,
