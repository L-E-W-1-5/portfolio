...
export const projects = [
    ...
    },
    {
        ...
        Initially I assumed that this would take far too much time, generating 700 signed URL's, 700 requests to the S3 before it would start playing the video, but it actually only took a few seconds to generate all the signed URL's, add them back into a list (a .m3u8 file) and start the video playing.
        ...
        I feel like I levelled up hugely during this project. Now I have the problem of wanting to go back to older projects and redo large pieces I now know how to improve, starting a new project (I again want to use tech and skills i've never used before, I have a couple of interesting ideas) or i still have a lot to fix on Luluflix.. 
        ...
        The other option is streaming the file instead of uploading in batches, this is something I have never done and seems complex. I gather that I loop the segments on the client side, sending one at a time and on the backend I change the storage settings for Multer and store the file in the S3 bucketso in theory it barely affects the memory of the server. The first option requires a lot less changes to my code and a lot less research but the second option seems like the more efficient, more widely used approach and it definitely looks a better way of doing it so I will be looking into both.`,
        stages: [
                    {
                        photo: login,
