...
export const projects = [
    ...
    },
    {
        ...
        details: `A web application with a front end made using React, Typescript and Bootstrap and a back end made with Node.js, Express and Postgres, along with an AWS S3 bucket. It acts similarly to popular movie streaming sites or with alteration to the user database plus some extra UI components, it could also be similar to YouTube.
